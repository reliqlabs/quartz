...
- **Multi-model adversarial review**: three rounds complete.
  ...
  - Pending: Round C on the 4 unattacked Quint specs (handshake, attestation, pingpong, transfers) + adversarial review on the 43 Verus invariants and 39 Kani harnesses (per ledger).
