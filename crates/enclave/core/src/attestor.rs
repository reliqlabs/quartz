...
impl Attestor for DstackAttestor {
    ...
    fn attestation(&self, user_data: impl HasUserData) -> Result<Self::Attestation, Self::Error> {
        ...
        // The enclave produces the raw quote. The host can either:
        // 1. Submit it as DstackAttestation (raw quote, for on-chain DCAP)
        // 2. Generate a zkdcap proof and submit as DstackZkAttestation
